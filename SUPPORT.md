...
Hello, thank you for using Unmute Images on GitHub! 🙋🏻‍♂️  
...
- Check the [`README`](https://github.com/igorskyflyer/userscript-github-unmute-images/blob/main/README.md) for documentation and setup guidance.
- Search [`issues`](https://github.com/igorskyflyer/userscript-github-unmute-images/issues) to see if your question has already been answered.
...
- open a [`new issue`](https://github.com/igorskyflyer/userscript-github-unmute-images/issues) using the appropriate issue template and with the label of `bug`,
- include details such as:
   - steps to reproduce
   - Unmute Images on GitHub version
...
Do so by:
- opening a [`new issue`](https://github.com/igorskyflyer/userscript-github-unmute-images/issues) using the appropriate issue template and with the label of `feature`,
...
- See [`CONTRIBUTING.md`](https://github.com/igorskyflyer/userscript-github-unmute-images/blob/main/CONTRIBUTING.md) for guidelines.
...
If you'd like to support further development of Unmute Images on GitHub:
...
<div align="center">
  Thank you for using Unmute Images on GitHub!
  <br>
